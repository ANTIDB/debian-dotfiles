" Created and Used By Wang Shiyi
" 2012/7/24
"
"------------------
"-- SECTIONS
...
" nmap <C-w> <Plug>(openbrowser-smart-search)
" vmap <C-w> <Plug>(openbrowser-smart-search)
...
" map <F11> <ESC> :set wrap!<CR>:set wrap?<CR>i
...
noremap <F12> :!ctags -R --c-kinds=+p --c++-kinds=+p --fields=+iaS --extra=+q .<cr>
